...
const Nav = () => {
  ...
  return (
    <div className="md:flex w-full fixed top-0 left-0 my-6 lg:space-x-20">
      ...
      <ul
        className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-[30rem] transition-all duration-500 ease-in bg-[#3B3054] md:bg-white h-screen opacity-80 md:opacity-100 md:h-auto md:ml-auto ${
          open ? 'block' : 'hidden'
        }`}>
        {Links.map((link) => (
          <li
